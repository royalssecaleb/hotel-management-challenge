        ...
        <div className="card_container">
            ...
            <div>
                ...
                <div className="description">
                    ...
                    <div className='mt-4'>
                        <Button className={"btn w-full hover:bg-[rgb(26,101,238)] hover:text-white hover:border hover:border-[rgb(26,101,238)]"} content={`Book now for $${price}`} handleClick={()=>{alert('buy credit')}}/> <Button />
                    </div>
                </div> 
            </div>
        </div>
